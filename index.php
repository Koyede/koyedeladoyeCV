...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Koye's Cv</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">I am Koyede Ladoye</h1>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="skill-mf">
                  ...
                  <span>REACT/REDUX</span> <span class="pull-right">60%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>Node Js</span> <span class="pull-right">70%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>Express Js</span> <span class="pull-right">90%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>MONGO DB</span> <span class="pull-right">86%</span>
                  <div class="progress">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Sound knowledge of the full lifecycle development for systems and software.
                    Ability to convert high-level requirements into outstanding user experiences.
                  </p>
                  <p class="lead">
                    Exceptional knowledge of IDEs, application servers, Glassfish, relational databases, POSTGRES CMS applications, and operating systems.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Profound knownledge in web design and ability to accurately estimate 
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Outstanding ability to dictate simple to complex web experience eloquently
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Remarkable ability to rapidly prototype functional requirement with limited supervision
  ...
  <section id="work" class="portfolio-mf sect-pt4 route">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="https://react-ecommerce-phone-app.netlify.com" >
              <div class="work-img">
          ...
          <div class="work-box">
            <a href="img/work-3.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">A Design website using Html, Css, Bootstrap and jquery</h2>
                    <div class="w-more">
                      <span class="w-ctegory">Web Development</span> / <span class="w-date">12 Jul. 2018</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/work-4.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">A photography website </h2>
                    <div class="w-more">
                      <span class="w-ctegory">Web Development</span> / <span class="w-date">20 Oct. 2018</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="file:///C:/Users/LFG/Desktop/js%20cont/js%20Projs/Guessing%20Color/index.html">
              <div class="work-img">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Color game </h2>
                    <div class="w-more">
                      <span class="w-ctegory">Web Development</span> / <span class="w-date">14 Feb. 2017</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Haleem Olatinwo</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Koyede is an Exceptional developer, He created a unique design for my Cloths store website.
                  He loves coding and as a passion for creative web-apps.
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Ayomide Bajo</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Koye has great web development skills. Have seen a great number of his completed projects,
                  they are all very impressive, speaking from a developer's P.O.V myself.
                </p>
                <span class="comit"><i class="fa fa-quote-right"></i></span>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="blog-single.html"><img src="img/haircut-1.jpg" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <img src="img/haircut-5.jpg" alt="" class="avatar rounded-circle">
                  <span class="author">Tolu olabanji</span>
                </a>
              </div>
              <div class="post-date">
                <span class="ion-ios-clock-outline"></span> 14 min
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="blog-single.html"><img src="img/haircut-2.jpg" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
            ...
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <img src="img/haircut-6.jpg" alt="" class="avatar rounded-circle">
                  <span class="author">Oke Capelo</span>
                </a>
              </div>
              <div class="post-date">
                <span class="ion-ios-clock-outline"></span> 36 min
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="blog-single.html"><img src="img/haircut-3.jpg" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
            ...
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <img src="img/haircut-7.jpg" alt="" class="avatar rounded-circle">
                  <span class="author">Ani Joshua</span>
                </a>
              </div>
              <div class="post-date">
                <span class="ion-ios-clock-outline"></span> 2 hours ago
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-ios-telephone"></span> +(234) 0933957916</li>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Koye's CV</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="https://bootstrapmade.com/">Koyede</a>
              </div>
            </div>
          </div>
        </div>
